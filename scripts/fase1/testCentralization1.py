...
5 - shapes are indentified inside the potential squares;
6 - if 3 or more shapes are indentified with the same center -> base;
...
if __name__ == '__main__':
    ...
    # If you are testing on terminal only -> False:
    DEBUG = False
    
    detection = CrossDetection()

    def test_video():
        # parameters = [[94, 70, 0], [255, 255, 255], [0, 0, 0]]
        parameters = [[0, 0, 0], [255, 255, 255], [1, 0, 0]]
        # parameters = [[0, 255, 255], [24, 255, 255], [0, 0, 0]]

        video = cv2.VideoCapture('CBRbase/video4.webm')
        ...
        while(video.isOpened()):
            ...
            # print(f"{psutil.cpu_percent()} / {psutil.virtual_memory().percent}")
            # if i%10 == 0:
    ...
    def test_live():
        ...
        initial = [[0, 0, 0], [255, 255, 255], [1, 0, 0]]
